...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="grid h-screen w-screen place-items-center gap-1 bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
        <div className="grid place-items-center text-center">
          <h1 className="mt-8 text-5xl font-bold">
            Days since last chalga song:
          </h1>
          <h1 className="mt-4 text-9xl font-bold">
            {calculateDaysBetwenDates(
              new Date(Date.now()),
        ...
        >
          <div className="mt-8 grid w-screen justify-items-center text-black">
            <div className="flex h-80 w-4/5 flex-col items-center rounded-3xl bg-white sm:h-44 sm:flex-row sm:pl-7 md:w-7/12 ">
              <Image
